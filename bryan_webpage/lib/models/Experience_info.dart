...
final List<ExperienceInfo> demo_experience = [
  ExperienceInfo(
    company: "Tecmilenio",
    position: "Tech teacher",
    date: "From January 2024 to Present",
    label:
        "Teaching subjects about Software Development, using Python with good development practices. Also teaching a little bit about agile methodologies.",
  ),
  ExperienceInfo(
    company: "Coppel",
    position: "Project Leader / Scrum Master",
